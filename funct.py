...
def getpersonality():
    ...
    print('This is how I spend my lunch breaks:')
    print('A. I do homework.')
    print('B. I bring my own lunch and play video games.')
    print('C. I visit the instructor\'s office hours and try to get the best marks.')
    print('D. I go out with friends and I usually eat too much.')
    q6 = input('Enter A, B, C, OR D: ')
    print('During exam week:')
    print('A. I show up 5 minutes late because why should I show up on time?')
    print('B. I show up 10 minutes early just in case something happens.')
    ...
    print('C. I would pretend to like them because I want people to think that I am nice and believe in inclusivity.')
